...
//		
	...
	public class regEvent implements ActionListener 
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			int registerchk = registerCheck(array);
			if(registerchk == 1)
			{
				try {
	...
	public int registerCheck(ArrayList<String> array)
	{
		int chk=0;
		...
		if(name.equals("")  || un.equals("") || dep.equals("--select department--") || dob.equals("DD/MM/YY") || dob.equals("") || adr.equals("") || x.equals("--select type--") )
		{
			chk = 9 ;
		}
		else
